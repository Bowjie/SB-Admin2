...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                ?>
                <a class="navbar-brand" href="index.html">Hello! <?=$fn.' '.$ln;?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?=base_url('sbadmin2/logout');?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user --> 
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?=site_url('sbadmin2/dashboard');?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?=site_url('pages/tables');?>"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li>
                            <a href="<?=site_url('pages/form')?>"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                        <li>
                        ...
                        <div class="panel-body">
                         ...
                         {  
                            foreach ($fetch_data as $key => $value) 
                            {
                                echo "<tr>",
                                     ...
                                     "<td>".$value->user_co_num."</td>",
                                     "<td>".$value->user_email."</td>",
                                     "<td>".$value->user_gender."</td>",
                                     "<td align='center'>"."<input type='checkbox' id='update' name='update'>"."</td>",
                                     "</tr>";
                            }
                         }
                         else
                         {
                          ...
                          ?>   
                               ...
                               <div align="center"> 
                                    <input type="button" class="btn" id="update" name="update" value="ALTER SELECTED">
                                    <input type="button" class="btn" id="update" name="update" value="DELETE SELECTED">
                                </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?=base_url()?>sbadmin2/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="<?=base_url()?>sbadmin2/vendor/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="<?=base_url()?>sbadmin2/vendor/datatables-responsive/dataTables.responsive.js"></script>
